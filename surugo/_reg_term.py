...
PATHS = ['hardware/stl/v5/v5_bridge.stl', 'hardware/stl/v5/v5_strap_a.stl', 'hardware/stl/v5/v5_strap_b.stl', 'hardware/stl/v5/v5_strap_c.stl', 'hardware/stl/v5/v5_inabar.stl']
