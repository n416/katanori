...
| 電源 | 電池駆動（電池 → PowerBoost 直結・USB なし） | ✅ 起動・完全停止・再起動まで確認（2026-09-02）。稼働時間・ピーク電流は未実測 |
...
2. **稼働時間とピーク電流の実測** — 満充電から LBO が落ちるまで。ピークは次の板の昇圧を 1A にできるかの決め手
...
- **勝手に再起動する**（2026-09-11・原因未特定）。起動の声が 5〜15 分おきに鳴り、電池を使い切った。2026-09-24 にユーザー判断で追わないことにした（クローズ）。
