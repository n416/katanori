...
急いで組むと、本当に Ver3 が要る。図（[relay_board.html](../hardware/parts/relay_board.html)）は
...
寸法は [case_v4.scad](../hardware/frozen/v1-v4/case_v4.scad) の板 6 枚を `--backend=manifold` で焼いた
...
![v1〜v4 と StackChan](../hardware/frozen/v1-v4/renders/case_v1_v4_stackchan.png)
...
| | 何が変わったか | なぜ |
|---|---|---|
| v1 | [case_pack_front2.scad](../hardware/frozen/v1-v4/case_pack_front2.scad) の箱詰めスタディから起こした最初の実物。上下 2 枚貝 | ── |
