...
樹脂の量は [hardware/stl/v4/](../hardware/stl/v4/) の 18 点（つまみ 2 点を含む）を `_vol.py` で積算したもの。
...
| 樹脂 | 🟡 **95〜103g** | STL 実測 **86.1cm³**（板・ブリッジ・留め帯など 16 点で 80.0cm³ ＋ つまみと島 6.1cm³。犠牲タブと支柱を含む）× 比重 **1.1〜1.2**（🟡 SK本舗 Ultra 高靭性 白の実値は未確認） |
| 合計 | 🟡 **208〜216g** | |
...
| **v4** | 2026-08-25 | 86.65 × 74.99 × 52.95 | 6,498mm² | 344.1cm³ | 84.354 × 72 × 48.454 | 61.6cm³ | 18 点 | 板 6 枚 |
...
v4 の印刷部品を全部足すと **80.0cm³**（外皮 61.6 ＋ 中の 8 点 15.7 ＋ 犠牲タブと支柱）で、
