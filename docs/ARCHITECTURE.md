...
| 電源（EN遮断） | 0 | **リードスイッチが機械的に切る。ファームは EN に触らない**（[POWER.md](POWER.md) 151行） | ✅ 決定済み |
...
| | 筐体 | 電池 |
|---|---|---|
| StackChan 187.2g | **込み** | ❌ **入っていない**（2026-08-14・ユーザー） |
...
🔴 **katanori 側の高さが未確定なので、「軽くて小さい」をまだ数字で主張できない。**
電池とスピーカーの厚みで決まる。筐体を進めるときに確定させること。
