...
STEPS = [
 ...
 dict(n='10', t='つまみを組み、天面に小組を付けて配線する', img='st10', acts=[
   ...
   '押さえるのは<b>ピンセット</b>——<b>指 φ12 は入らない</b>（AS5600 の柱 4 本に、ポケットの口の 7.6mm 手前で止まる）。'
   '柱のあいだに空いているのは <b>φ9.1</b> まで。',
...
<div class="callout">
  ...
  <ul>
    ...
    <li><b>道具</b>: ドライバは先端 φ3.2 以下（座ぐりが φ3.4 なので、太いと頭に届かない）。
        ...
        （<span class="n">knob_v5.scad</span> の <span class="n">part="rod"</span> は
        🔒 ユーザー判断で<b>刷らない</b>——押し込む深さは穴の天井が決めているので、ゲージは要らない）。</li>
