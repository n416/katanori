...
STEPS = [
 ...
 dict(n='12', t='トグル・床の板・ハッチ・電池の蓋・尻尾', img='st12', acts=[
   ...
   '<b>床の板（<span class="d">print_shutfloor</span>）は、ハッチを箱に付ける前に仕上げて貼る。</b>'
   '溝の床・磁石の座 2 つ・ロックのナットのボスを持つ、厚さ 1.2mm の別部品。順番は次の 3 つ。',
   '① <b>磁石 2 個を板へ先に入れる。</b>座は <span class="d">φ6.0</span> で<b>丁度いい圧入</b>'
   '（実績: ELEGOO・ユーザー「取れないです」）。板を<b>溝の床の面を下にして平らな台へ置き</b>、'
   '裏側から押し込む。貼ってからでは押す力が接着面にかかる。'
   '⚠ 座の底は <span class="d">0.4mm</span> しかない。台の上で受けること。',
   '② <b>ロックの <span class="d">M2</span> ナット 1 個を板のボスへ落とし込む。</b>'
   'ボスの頭に溝が彫ってあり、そこから六角のポケットへ滑らせる。'
   'ハッチを箱に付けた後では、このボスは箱の中で手が届かない。',
   '③ <b>板をハッチの内面へ接着する。</b>ハッチ側に立っている<b>爪 2 つ</b>'
   '（帯の左の端と、下の帯の中ほど）に、板の欠き 2 つを合わせると位置が決まる。'
   '接着面は帯のまわりの平らな縁で、<span class="d">約 239mm²</span>。',
   '電池の蓋: 磁石を蓋に 2 個（<b>圧入</b>・板側の 2 個は上の ① で済んでいる）。蓋を逃がし口へ入れて<b>左へ 5.5mm</b> ずらし、'
