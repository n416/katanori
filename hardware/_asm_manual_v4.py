...
STEPS = [
 ...
 dict(n='5', t='ブリッジを上から降ろす', img='st5', acts=[
   ...
   '帯の裏の左端に <b>Type-C 基板の押さえ</b>（<span class="n">X 1.694〜3.9・Y 58.6〜62.2</span>・下端 <span class="n">Z 20.7</span>）が付いている。ここが基板の Z の抜け止めなので、<b>ブリッジを載せるまで基板は上へ抜ける。</b>',
    ...
    open_='留め帯 3 本が上へ抜けるのを止める物がまだ無い（<b>CASE-V4-OPEN.md</b> A-4）。前の脚はビス無しで床の溝に座るだけだが、ビスの一番前（<span class="n">Y 34.0</span>）から前への張り出しは片持ち 20mm で、たわみは ⚠ 概算 0.013mm（<b>CASE-V4-OPEN.md</b> A-3）。'),
 ...
 dict(n='7', t='留め帯 A・B・C をかぶせる', img='st7', acts=[
   ...
   'A は電流計の前穴、B は電流計の後穴と PowerBoost の前 2 穴、C は PowerBoost の後ろ 2 穴を受ける。',
    ...
    open_='帯自身の Z の抜け止めが無い。足はレールの切れ目に座るだけ（<b>CASE-V4-OPEN.md</b> A-4）。'),
