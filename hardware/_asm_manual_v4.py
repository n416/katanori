...
STEPS = [
 ...
 dict(n='10', t='天面の小組と、天面側の配線', img='st10', acts=[
   '天面を<b>裏返して</b>置き、AS5600 の基板をつまみの島の 4 本の柱へ <span class="d">M2×6</span> ×4'
   '（下から・ナットは柱のスロット）。',
   '会話ボタンの受けとキャップ、スピーカー（両面テープ・枠が天板の座に沈む）、'
   'リードスイッチ（デッキのポケットへ直はんだ）。',
...
<div class="callout">
  ...
  <ul>
    ...
    <li><b>ナットには 2 種類ある。</b>留め帯の 6 個は<b>横穴</b>なので、差せばどう向けても落ちない。
        それ以外は全部<b>上向きのポケットに置くだけ</b>——落としてから締めるまで、箱を傾けない。</li>
