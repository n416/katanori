...
STEPS = [
 ...
 dict(n='9', t='OLED を立て、上の道の 5 束と電源の 7 本を通す', img='st9', acts=[
   ...
   '<b>電源の 7 本</b>: 電池のタブ → 電流計の <span class="w">INPUT</span>、'
...
CHECKS = [
 ...
 ('電池を後ろから差し込む', 'CHK="bat"', '<b>0</b>', 'ok',
  '留め帯 3 本が入った鞘を 55mm 通す。交換のときの引き出しと同じ道'),
 ...
 ('電池の交換の道（組んだ後）', 'chk_shut_slide / chk_lock_out / chk_shut_out / chk_swap', '<b>0 / 0 / 0 / 0</b>', 'ok',
  '蓋を横へずらす・ロックを後ろへ外す・蓋を後ろへ抜く・電池を後ろへ引き出す、の 4 本とも 0'),
]
...
<header class="mast">
  ...
  <p class="sub">印刷部品 18 点・ビス 27 本・線 13 束 39 本（ほかにアンテナの同軸が 1 本）を、この順番で組む。
