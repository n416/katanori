...
STEPS = [
 ...
 dict(n='8', t='電流計と PowerBoost を座に締める', img='st8', acts=[
   '座は板の裏と同じ面。<b>傾きは 2 枚で別</b>で、PowerBoost は <b>10°</b>、電流計は 🔒 2026-08-26 から <b>水平（0°）</b>。'
   ...
   '掛かりは <span class="n">1.37 / 1.56 / 1.56 / 1.6 / 1.6 / 1.6mm</span>（ナットの厚み 1.6 に対して）。先はどの穴も天板の裏の内側で止まる。'
   '⚠ <b>電流計の 2 本は余裕 <span class="n">0.1mm</span></b>（座が水平になって <span class="n">2.5</span> しか無いため）。PowerBoost の 4 本は <span class="n">0.54〜3.63mm</span>。',
 ], warn='上限を超えると先が天板の裏を抜けて<b>電池の頭を突く</b>（天板の裏＝電池の上面で、隙間はゼロ）。🔴 2026-08-25 夜の板の 0.5 持ち上げ（<b>CASE-V4-LOG.md</b> §13.7）で、先が出る穴は無くなった。⚠ 2026-08-26 に電流計を水平にしたので、一番きついのは電流計の 2 本で残り <span class="n">0.1mm</span>。長い物に替えないこと。',
