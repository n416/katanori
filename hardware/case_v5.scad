...
INA_BAR_HOLE_D = fit_hole_down(INA_PEG_D);   // 3.5。小帯の凹みは口がプレート側の止まり穴なので ダボ + 0.5（parts/fit.scad・🔒 2026-09-10 ゲージ）。旧: 3.0 → 3.35（C）→ 数式
...
INA_LEG_HOLE_D = fit_hole_up(INA_BAR_PEG_D);   // 3.0。天板の棒の穴は口が上の止まり穴なので ダボ 2.9 + 0.1（parts/fit.scad）。刷った天板（2026-09-09-1413）も 3.0
