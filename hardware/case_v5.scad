...
GROW_Y = 3.0;    // 🔒 ユーザー 2026-09-05「意味不明な拡大はおかしいでしょ」: 8 → 0 → 電流計の I2C の L 字（振れない）がハッチの床の板に 2.8 かかり「3mm 筐体を伸ばそう」: 3
...
INA_SX  = -1.0;                     // 🔒 ユーザー 2026-09-05 …→「右に 4mm」→「右に 2mm」: −7 → −3 → −1。電流計だけ動く
