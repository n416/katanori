...
//       胴は下と後ろが開いた受けに、ハッチを倒し込む弧で入る。⚠ ハッチを真後ろへ引く動きは、唇がバーの下を滑るだけで止める物が無い（v3/v4 と同じ）
...
// ============================================================
NUT_AF = 4.20;   // 🔴 2026-09-05 実機: 4.10（ポケット 4.20）では床の柱のナットが入らなかった。PRINT.md §2「六角ポケットは呼び + 0.3 でジャスト」に戻す（4.20 + 0.1 = 4.30） NUT_T = 1.8; SCR_D = 2.5; SCR_CB = 4.4; SCR_CBT = 1.6;   // v4 case_base の値（ナット二面幅 4.1・厚 1.8・通し φ2.5・座ぐり φ4.4 × 1.6）
