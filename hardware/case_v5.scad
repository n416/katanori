...
INA_BAR_H = 3.1; INA_BAR_T = 1.5; INA_BAR_FOOT_D = 6.0; INA_BAR_W = 1.25; INA_BAR_HOLE_D = 3.35;   // 小帯: 足の高さ（板の上から）・橋の厚み・足の径・橋の幅・穴 φ3.0（🔒 ユーザー 2026-09-10「3mm にして。ボトム公差は切る」: 補償 OFF で刷るので真の φ3.0。参考: as5600_holder の台座はこの径で刷ってあり、ダボ 3.1 で良い・3.2 で入らない。ここのダボは 2.75）
