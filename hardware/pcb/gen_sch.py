...
c("C6", "100uF", X0 + 47, Y0 + 4, "V5", "GND", fp="Capacitor_SMD:C_1210_3225Metric")
r("R3", "1.87M", X0 + 44, Y0 + 12, "V5", "FB")
r("R4", "200K", X0 + 47, Y0 + 12, "FB", "GND")
r("R1", "1.87M", X0 + 16, Y0 + 12, "VSYS", "LBI")
r("R2", "340K", X0 + 19, Y0 + 12, "LBI", "GND")
...
r("R6", "270K", X0 + 32, Y0 + 26, "VBUS", "VPCC")
r("R7", "100K", X0 + 35, Y0 + 26, "VPCC", "GND")
