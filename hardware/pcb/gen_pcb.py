...
POWER_V61 = {
    ...
    # ---- Y 9.5 / 11.0 ----
    "C2": (22.0, 9.5, 0),                               # 昇圧の出力（U1 の隣・ホットループ）
    ...
    "C6": (44.0, 23.0, 0), "C9": (47.0, 23.0, 0),      # V5 の大容量
    # ---- Y 27.0（印の LED）----
...
def build():
    ...
    _KELVIN = kelvin_tracks(placed) + [escape_stub(placed, "U2", "9", "VBUS"),
                                       escape_stub(placed, "U2", "13", "PROG1")]
