...
POWER_V61 = {
    ...
    #   🔴 同じ轍の 2 回目: v6 でも「CC の引き下げは USB-C の足元」と書いたのに（PLACE_V6 の R44 の注）、
...
FIXED_V61 = {
    ...
    "SW2": VB.PWR_BTN,
    # C31（リレー側 V5 の 0.1µF）: v6 の写しの位置（板 22.1, 31.1）が SW2 の枠と 1.46 × 3.4 重なり、押し離しで退かなかった（2026-09-19）。
    #   SW2 の真下（前）の空きへ。キャップの受けの下（板 X 23.8〜27.2・Y 34.4〜）は背 1.25 が当たるので避けた
    "C31": (22.9, 27.15, 0),
}
