...
POWER_V61 = {
    ...
    "R45": (39.9, 27.8, 270), "R44": (42.0, 27.8, 270),  # CC2（B5 の下）・CC1（A5 の下）
    # ⭐ 2026-09-19: THERM は U2 の左下の 5 番の下へ（前は Y 5.0 の列で 9.4mm）。180° で 2 番（THERM）が左
    "R15": (32.75, 10.7, 180),                          # THERM（5 番）
    "R46": (44.0, 7.6, 0),                              # Q2 のゲート（J2 のライザーの枠 Y 6.54 の後ろ）
    # ---- Y 9.5 / 11.0 ----
    ...
    "R42": (17.0, 15.5, 0), "R43": (17.0, 17.6, 0),
    # ---- Y 23.0（分圧と大きいコンデンサ）----
    "R1": (21.8, 23.0, 0), "R2": (25.3, 23.0, 0),       # LBI
...
RELAY_V61 = {
    ...
    "R31": (44.2, 17.5, 0), "R32": (44.2, 19.5, 180),   # ベースの直列と引き下げ（どちらも BASE の足が右 ＝ Q31 の 1 番の側）
}
