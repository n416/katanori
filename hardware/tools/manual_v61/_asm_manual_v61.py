...
STEPS_R = [
 ...
 dict(n='2', t='PCB を柱に載せ、電池を J10 に挿す', img='r2', acts=[
   ...
   '板の上から <span class="d">M2×6</span> を <b>前の 2 本</b>（ナットは床の裏）。<b>後ろの 2 本は板の上からは締めない</b>── 壁の羽が板の下に入ってから、手順 9 の最後に床の裏から <span class="d">M2×15</span>（羽の頭のナット。板は羽の頭に載るだけ。🔒 ユーザー 2026-09-18「組み立てづらくなるけど a で行こう」: 上からだと頭の 23 上に壁の上の柱が同軸で居てドライバーが入らない）。',
