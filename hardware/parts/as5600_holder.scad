...
//    ・基板は**バスタブ 2**（別部品）へ M2×6 4 本＋ナット 4 個。台座の裏の手 4 本を
//      バスタブ 2 の壁が外から掴み、横ねじ M2×6 4 本で留める（2026-09-08 の形）
//    ・島の留めは M2×6 のねじ 2 本（ナットは台座の裏の六角ポケット）
//    ⚠ 2026-09-09: ここは長らく「四隅のスタンドオフ ＋ M2 ナット4個」「M2.5 ナイロン」と書いてあった。
//      スタンドオフも棒 4 本も E リング（呼び3）も、いまは無い
