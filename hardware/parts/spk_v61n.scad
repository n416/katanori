// ============================================================
// スピーカー v6.1n — parts/spk_v61.scad の写し（MJF ナイロン用）
//   🔒 ユーザー 2026-09-14「レジンはノブだけでいでしょ」: バスタブも MJF で刷る。
//   MJF PA12（JLC3DP）: 公差 ±0.3・穴の公差 ±0.3・最小肉 1.0
// ============================================================
...
S_HEX_AF = 2.2; S_HEX_WALL = 1.0;   // ハニカム: 六角の二面幅 2.2・穴どうしの肉 1.0。v6.1n 2026-09-15: 0.6 → 1.0（MJF の最薄 0.8・壁 1.2。0.6 は `--mat nylon` で 🔴 48 か所）。レジンの 0.6 は spk_v61.scad
...
// v6.1n: 六角は 呼び 4.0 ＋ 0.5（レジンの実績は +0.3。MJF は穴の公差 ±0.3 を積む）
S_NUT_AF = 4.5; S_NUT_T = 1.8; S_SKIN = 0.7; S_SCR_D = 2.5;
