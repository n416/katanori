...
// ⚠ 2026-09-01: この道具は **case_v3 の世界**で動く 2026-08-24 のスタディです。会話ボタンは
//    v1 のタクト（`tactswitch()` / `BTN_AT` / `Z_TSW_BOT`）のまま。**現行の v4 は v3 のレバー式**
//    （`btn_v3.scad` / `BTN4`）なので、ここの記述を現行として引かないこと。
// ============================================================
