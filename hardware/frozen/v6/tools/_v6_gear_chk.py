...
"""v6 機構の当たり検査を 1 本ずつ回す。
  python hardware/frozen/v6/tools/_v6_gear_chk.py             … _v6_gear.scad の chk_* を全部
  python hardware/frozen/v6/tools/_v6_gear_chk.py chk_mesh_ki … 名前を指定
...
SCAD  = os.path.join('hardware', 'frozen', 'v6', '_v6_gear.scad')
OSC   = r'C:\Program Files\OpenSCAD (Nightly)\openscad.exe'
OUT   = os.path.join('hardware', 'frozen', 'v6', 'chk')
