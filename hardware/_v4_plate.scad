...
module plate_all() {
    ...
    plate_label(0.000, 288.770, "post_0", "11.5 x 13.2 x 10.7  09-02 05:30");
    color(PLATE_COLOR) translate([63.732, 306.120, 0]) import("stl/v4/v4_post_1.stl");
    plate_label(57.972, 288.770, "post_1", "11.5 x 13.2 x 10.7  09-02 05:30");
    color(PLATE_COLOR) translate([5.530, 338.400, 0]) import("stl/v4/v4_post_2.stl");
    plate_label(0.000, 320.980, "post_2", "11.8 x 12.1 x 11.0  09-02 05:30");
    color(PLATE_COLOR) translate([122.152, 339.890, 0]) import("stl/v4/v4_post_3.stl");
    plate_label(114.332, 320.980, "post_3", "14.6 x 11.9 x 14.8  09-02 05:30");
    color(PLATE_COLOR) translate([120.282, 271.770, 0]) import("stl/v4/v4_post_4.stl");
    plate_label(114.332, 252.640, "post_4", "9.6 x 13.5 x 11.4  09-02 05:30");
    color(PLATE_COLOR) translate([7.160, 272.780, 0]) import("stl/v4/v4_post_5.stl");
    plate_label(0.000, 252.640, "post_5", "14.6 x 17.1 x 14.4  09-02 05:30");
