...
module plate_all() {
    ...
    color(PLATE_COLOR) translate([181.304, 326.450, 0]) import("stl/v4/v4_btn.stl");
    plate_label(172.304, 309.450, "btn", "18.0 x 12.0 x 10.0  08-28 19:30");
    color(PLATE_COLOR) translate([126.944, 327.350, 0]) import("stl/v4/v4_btnplate.stl");
    plate_label(115.944, 309.450, "btnplate", "15.4 x 12.9 x 1.5  08-29 00:56");
    color(PLATE_COLOR) translate([114.332, 302.250, 0]) import("stl/v4/v4_btntest.stl");
    plate_label(114.332, 263.450, "btntest", "72.4 x 22.0 x 11.3  08-28 23:55");
    ...
    color(PLATE_COLOR) translate([52.460, 331.950, 0]) import("stl/v4/v4_shutter.stl");
    plate_label(56.360, 341.450, "shutter", "50.2 x 11.8 x 2.8  08-28 19:30");
    color(PLATE_COLOR) translate([161.920, 337.390, 0]) import("stl/v4/v4_strap_a.stl");
    plate_label(170.920, 341.450, "strap_a", "40.0 x 8.4 x 9.0  08-28 19:30");
    ...
    color(PLATE_COLOR) translate([105.560, 301.850, 0]) import("stl/v4/v4_strap_c.stl");
    plate_label(114.560, 341.450, "strap_c", "40.0 x 10.0 x 9.4  08-28 19:30");
