...
module plate_all() {
    ...
    plate_label(0.000, 94.054, "rwall", "48.5 x 71.0 x 9.0  09-04 22:45");
    ...
    plate_label(114.332, 253.054, "shutfloor", "61.1 x 14.5 x 3.6  09-04 22:29");
    color(PLATE_COLOR) translate([167.292, 278.604, 0]) import("stl/v4/v4_shutter.stl");
    plate_label(170.692, 288.104, "shutter", "53.0 x 11.8 x 2.8  09-04 22:25");
    color(PLATE_COLOR) translate([-9.000, 315.626, 0]) import("stl/v4/v4_strap_a.stl");
    plate_label(0.000, 320.076, "strap_a", "40.0 x 11.0 x 11.9  09-04 22:29");
    color(PLATE_COLOR) translate([47.360, 232.854, 0]) import("stl/v4/v4_strap_b.stl");
    plate_label(56.360, 253.054, "strap_b", "40.0 x 15.6 x 16.3  09-04 22:29");
    color(PLATE_COLOR) translate([48.972, 281.376, 0]) import("stl/v4/v4_strap_c.stl");
    plate_label(57.972, 320.076, "strap_c", "40.0 x 10.9 x 12.7  09-04 22:29");
    color(PLATE_COLOR) translate([6.486, 305.590, 0]) import("stl/v4/v4_tail.stl");
    plate_label(0.000, 288.104, "tail", "13.0 x 13.0 x 33.7  09-04 22:25");
    color(PLATE_COLOR) translate([0.306, 85.000, 0]) import("stl/v4/v4_top.stl");
    plate_label(0.000, 0.000, "top", "86.7 x 75.1 x 20.9  09-04 22:25");
    color(PLATE_COLOR) translate([198.782, 269.954, 0]) import("stl/v4/v4_tub.stl");
    plate_label(183.432, 253.054, "tub", "30.7 x 13.5 x 9.3  09-04 22:25");
}
