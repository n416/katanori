...
module plate_all() {
    ...
    plate_label(57.972, 309.450, "btn", "18.0 x 12.0 x 10.0  08-27 13:08");
    ...
    plate_label(0.000, 263.450, "knob", "27.0 x 27.0 x 21.4  08-27 14:58");
    color(PLATE_COLOR) translate([68.972, 285.450, 0]) import("stl/v4/v4_knobwall.stl");
    plate_label(57.972, 263.450, "knobwall", "22.0 x 24.0 x 3.9  08-27 14:58");
    color(PLATE_COLOR) translate([83.944, 299.950, 0]) import("stl/v4/v4_lock.stl");
    plate_label(115.944, 309.450, "lock", "28.7 x 11.8 x 3.0  08-27 13:08");
    ...
    plate_label(114.332, 263.450, "seat", "21.6 x 16.0 x 4.2  08-27 13:08");
    color(PLATE_COLOR) translate([168.404, 299.950, 0]) import("stl/v4/v4_shutter.stl");
    plate_label(172.304, 309.450, "shutter", "50.2 x 11.8 x 2.8  08-27 13:08");
    color(PLATE_COLOR) translate([47.360, 337.362, 0]) import("stl/v4/v4_strap_a.stl");
    plate_label(56.360, 341.422, "strap_a", "40.0 x 8.4 x 9.0  08-27 13:08");
    color(PLATE_COLOR) translate([161.692, 243.250, 0]) import("stl/v4/v4_strap_b.stl");
    plate_label(170.692, 263.450, "strap_b", "40.0 x 13.0 x 12.2  08-27 13:08");
    color(PLATE_COLOR) translate([-9.000, 301.822, 0]) import("stl/v4/v4_strap_c.stl");
    plate_label(0.000, 341.422, "strap_c", "40.0 x 10.0 x 9.4  08-27 13:08");
    color(PLATE_COLOR) translate([6.486, 326.936, 0]) import("stl/v4/v4_tail.stl");
    plate_label(0.000, 309.450, "tail", "13.0 x 13.0 x 33.8  08-27 13:08");
