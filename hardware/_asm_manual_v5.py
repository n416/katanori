...
STEPS = [
 ...
 dict(n='4', t='左右の壁を横から当て、床の裏から 3 本で留める', img='st4', acts=[
   ...
   '箱は<b>伏せずに</b>台に載せ、下から <span class="d">M2×15</span> を 3 本。<b>後ろ左のビスは無い</b>——そこは Type-C 基板の席で、後ろの床はハッチの爪 2 つが持つ。',
 ...
 dict(n='12', t='上の道の線を挿し、天板を載せ、フロントを差す', img='st12', acts=[
   ...
   '<b>フロントを前から差す。</b>窓が OLED を、ヒゲがマイクを受ける。耳が前の柱の上に載るので、天板の前の 2 本 <span class="d">M2×8</span> を上から（天板 2.5 ＋ 耳 3.2 ＋ 柱の肉 1.6 を通ってナット）。',
...
GLOSS = [
 ...
 ('耳', 'フロントの上の両端。天板の前の 2 本のねじがここを通って前の柱へ。', 'mimi'),
...
SCREWS = [
 ...
 ('M2 × 15', '3', '床の裏 → 左右の壁の下の柱（左前・右前・右後ろ）', '4'),
