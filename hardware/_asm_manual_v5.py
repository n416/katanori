...
STEPS = [
 ...
 dict(n='4', t='左右の壁を横から当て、床の裏から 3 本で留める', img='st4', acts=[
   ...
   '箱は<b>伏せずに</b>台に載せ、下から <span class="d">M2×15</span> を<b>後ろ右の 1 本だけ</b>。<b>前の 2 本は手順 12</b>——前の下の柱は床から 3.2 浮いていて、その隙間にフロントの下の耳が入ってからビスが 床・耳・柱 を通る。'
   '<b>後ろ左のビスは無い</b>——そこは Type-C 基板の席で、後ろの床はハッチの爪 2 つが持つ。',
 ...
 dict(n='12', t='上の道の線を挿し、天板を載せ、フロントを差す', img='st12', acts=[
   ...
   '後ろの 2 本 <span class="d">M2×6</span> を上から柱へ。',
 ...
 dict(n='13', t='ハッチに蓋とトグルを付け、爪を掛けて閉じる', img='st13', img2='claw',
   ...
   'トグルの胴が天板の裏の <span class="g">受け</span> に弧で入り、受けの両側の壁と前の当てが胴を持つ。<b>下＝爪、上＝ナット。</b>',
   'ハッチには充電の Type-C の口（左下）が開いている。Type-C 基板の殻の面は外面の 0.8 裏。',
 ], warn='ハッチを<b>真後ろへ引く</b>動きだけは、唇がバーの下を滑るだけで止める物が無い（v3・v4 と同じ）。閉じたら引かない。'),
]
...
GLOSS = [
 ...
 ('耳', 'フロントの四隅。上の耳は天板の前の 2 本、下の耳は床の裏からの前の 2 本が通る。', 'mimi'),
...
SCREWS = [
 ...
 ('M2 × 15', '3', '床の裏 → 左右の壁の下の柱。右後ろは手順 4、<b>前の 2 本はフロントの下の耳を通して手順 12</b>', '4 / 12'),
...
PARTS = [
 ...
 ('ハッチ', '1', 'Type-C の口・トグルの穴・蓋の彫り込み・爪 2 つ・反り止めの格子'),
 ('ブリッジ（皿と腕）', '1', '腕の上に格子'),
 ('前板', '1', ''),
 ('帯', '3', '同じ形'),
 ('蓋（シャッター）', '1', '磁石 2 個を圧入'),
