...
module spot_raft_bridge() difference() {
    ...
    translate([0, 0, -0.1]) linear_extrude(0.80) offset(r = 0.5)
        projection(cut = true) translate([0, 0, -0.15]) spot_body_bridge();
}
