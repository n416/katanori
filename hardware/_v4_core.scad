...
module w_pwr3() {
    ...
    color("#e53e3e") wire([[32.2, 70.5, 35.8 + BOARD_LIFT], [32.2, 70.7, 35.8 + BOARD_LIFT], [32.2, 70.7, 35.2], [64, 70.7, 35.2], [64, 70.7, 24], [64, 64.8, 24], [64, 64.8, 21]]);      // 5V
    color("#222222") wire([[24.58, 70.5, 35.8 + BOARD_LIFT], [24.58, 70.7, 35.8 + BOARD_LIFT], [24.58, 70.7, 33.7], [66.5, 70.7, 33.7], [66.5, 70.7, 26], [66.5, 64.8, 26], [66.5, 64.8, 21]]);   // GND
    color("#ecc94b") wire([[22.04, 70.5, 35.8 + BOARD_LIFT], [22.04, 70.7, 35.8 + BOARD_LIFT], [22.04, 70.7, 32.2], [69, 70.7, 32.2], [69, 70.7, 28], [69, 64.8, 28], [69, 64.8, 21]]);      // EN
}
...
module w_ina_i2c() color("#7f8c8d") {   // INA226 の I2C 4 本（ALER 裸）: 口 → 縦穴の後ろ寄り Y 68.1 を右へ → トグルとその線の東 X 51.6 で上がる →
    ...
    wire([[34.11, 64.76, 21.4], [34.11, 67.5, 21.4], [52.8, 67.5, 21.4], [52.8, 67.5, 40.6]], 2.2);
