...
const SYSTEM_INSTRUCTION = [
  ...
  // 「短く返答してください」は外した（2026-09-22 ユーザー「その無意味な指示は削除で」。
  // 昔話を頼んでも短く切り上げていた）
  "親しみやすく話してください。",
  "",
  "【名前の聞き取りについて】",
 ...
 *
 * 眠っている間に呼ばれたとき、機体はつながるまで画面に「ちょっと／まってね」「あと／すこし」を
 * 出す。待っている間に話しかけられたときだけ、自分の声で「ちょっと待ってね、いま起きたところ」
 * 「ワイファイがつながったよ、あと少し」「おまたせ！」と言う（firmware の pumpWakeWaitVoice・
 * VoiceClips.h）。Gemini はそれを知らないので、伝えないと挨拶を重ねる。
...
function wokeInstruction(woke: string): string[] {
  ...
  return [
    ...
    "つながるまでの間は画面に「ちょっとまってね」と出してあります。待っている間に話しかけられたときは、",
    "あなたはもう「ちょっと待ってね、いま起きたところ」「ワイファイがつながったよ、あと少し」「おまたせ！」のように言ってあります。",
